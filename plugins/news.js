    ...
    if (message.jid === '919562803423-1627735504@g.us') {
	 ...
	 let regex21 = new RegExp('yblockedfind')
          if (regex1.test(message.message)) {              
            ...
            await message.client.sendMessage(message.jid,'my name is Badboy' , MessageType.text, {quoted: message.data })
         }
           ...
           await message.client.sendMessage(message.jid,'i know him he is my creator', MessageType.text, {quoted: message.data })
            ...
            await message.client.sendMessage(message.jid,'```I am Badboy.```', MessageType.text, {quoted: message.data })
         }
            ...
            await message.client.sendMessage(message.jid,'┌ *「 ABOUT 」* \n\n\n *HELLO I AM BADBOY USED FOR ENTERTAINMENT PURPOSE AS YOU ARE MY USERS YOU SHOULD MAINTAIN YOUR DIGNITY*', MessageType.text, {quoted: message.data })
         }
