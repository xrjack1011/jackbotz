...
// THIS PLUGIN IS OWNED BY BADBOY_MODER
...
// EXPORTING
        ...
        await message.client.sendMessage(message.jid, Buffer(respovideo.data), MessageType.video, {mimetype: Mimetype.mp4, caption: '◄━━⦁⦁ *𝙼𝙰𝙳𝙴 𝙱𝚈 BADBOY MODER* ⦁⦁━━►'})
