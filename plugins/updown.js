...
if (pb.WORKTYPE == 'private') {
    Badboy.addCommand({ pattern: '.', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
    ...
    Badboy.addCommand({ pattern: '.', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
        if(message.fromMe) return
        let command = [ 
        'xmedia',
        'install',
