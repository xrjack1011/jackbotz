...
const code = "*╔═════◉ BADBOY BOT ◉═════╗*\n           BADBOY MODER😈\n*╚══▣══◉❖𝙿𝙰𝙲𝙺𝚂❖◉══▣══╝*\n\n*💠.animesay        ❴your text❵*\n*💠.changesay        ❴your text❵*\n*💠.trumpsay        ❴your text❵*\n*💠.miasay        ❴your text❵*\n*╚═══❖══▣══▣══❖═══╝*\n\n*▷𝙲𝙾𝙳𝙴𝙳 𝙱𝚈: BADBOY MODER😈*"

if (Config.WORKTYPE == 'public') {
    
      Badboy.addCommand({pattern: 'someonesay', fromMe: false, desc: Ln,}, (async (message, match) => {
...
Badboy.addCommand({ pattern: 'animesay ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
...
Badboy.addCommand({ pattern: 'changesay ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
...
Badboy.addCommand({ pattern: 'miasay ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
...
Badboy.addCommand({ pattern: 'trumpsay ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
