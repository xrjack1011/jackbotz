...
re-coded or modified by BADBMODER
to bring new ai
credit by afnanplk
*/
...
Asena.addCommand({ pattern: 'badboy ?(.*)', desc: fulleva_dsc, fromMe: true,dontAddCommandList: true, usage: '.badboy on / off' }, (async (message, match) => {
