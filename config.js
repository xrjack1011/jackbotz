...
module.exports = {
    ...
    SESSION: process.env.BADBOY_SESSION === undefined ? '' : process.env.BADBOY_SESSION,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AUTOBİO: process.env.AUTO_BİO === undefined ? 'false' : process.env.AUTO_BİO,
    REMOVE: process.env.THERI_KICK_GP === undefined ? 'false' : process.env.THERI_KICK_GP,
    AFN: process.env.ALL_CAPTION === undefined ? 'MADE BY BADBOY' : process.env.ALL_CAPTION,
    ...
    Z_BADBOY_AI: process.env.Z_BADBOY_AI === undefined ? 'false' : process.env.Z_BADBOY_AI,
    BADBOY: process.env.OWNER_NAME === undefined ? 'default' : process.env.OWNER_NAME,
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? 'BADBOY BOT' : process.env.BOT_NAME,
    SAID: process.env.BGM_DURATION === undefined ? '31996800' : process.env.BGM_DURATION,
    NOLOG: process.env.NO_LOG === undefined ? 'false' : process.env.NO_LOG,
    TALKING_BADBOY: process.env.TALKING_BADBOY === undefined ? 'false' : process.env.TALKING_BADBOY,
    ...
    BADBOYBGM: process.env.CHANGE_BGM_TO === undefined ? 'one' : process.env.CHANGE_BGM_TO,
    DEMOTEMSG: process.env.DEMOTE_MESSAGE === undefined ? 'default' : process.env.DEMOTE_MESSAGE,
    BANMSG: process.env.BAN_MESSAGE === undefined ? 'default' : process.env.BAN_MESSAGE,
    AFKMSG: process.env.AFK_MESSAGE === undefined ? 'default' : process.env.AFK_MESSAGE,
    TAGBADBOY: process.env.TAG_HEADER === undefined ? 'badboy' : process.env.TAG_HEADER,
